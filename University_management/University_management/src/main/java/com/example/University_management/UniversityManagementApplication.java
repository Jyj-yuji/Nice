...
public class UniversityManagementApplication {
	...
	private static Logger log = LoggerFactory.getLogger(UniversityManagementApplication.class);

	@Bean
	public Realm realm(){
		// uses 'classpath:shiro-users.properties'
